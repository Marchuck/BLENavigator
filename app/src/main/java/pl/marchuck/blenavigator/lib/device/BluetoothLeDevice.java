package pl.marchuck.blenavigator.lib.device;
...
import pl.marchuck.blenavigator.lib.resolvers.BluetoothClassResolver;
import pl.marchuck.blenavigator.lib.util.AdRecordUtils;
import pl.marchuck.blenavigator.lib.util.ByteUtils;
import pl.marchuck.blenavigator.lib.util.LimitedLinkHashMap;
